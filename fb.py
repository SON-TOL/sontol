...
def menu():
    ...
    print '\x1b[1;37;40m2. Rampas Akun Facebook'
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/channel/UCZ6uY1cD4n3PGrFLdjpE3yA')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
def menu_hack():
    ...
    print '\x1b[1;37;40m5. Yahoo Cloning'
